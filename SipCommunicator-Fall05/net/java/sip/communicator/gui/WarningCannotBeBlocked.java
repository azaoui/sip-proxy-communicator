...
public class WarningCannotBeBlocked extends JDialog{
	...
	public WarningCannotBeBlocked(BlockSplash blockSplash2, boolean modal){
        ...
        JLabel label = new JLabel("User cannot be blocked. Does not exist in our DB." );
